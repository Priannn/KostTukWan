                        ...
                        <div class="row ">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form  method="post" class="user" action ="<?=BASEURL; ?>/login/userr">
                                    ...
                                    <div class="text-center  justify-content-center">
                                        <p class="large"> Don't have an account yet?</p>
                                        <a class="small ml-1 mt-1" href="<?= BASEURL ?>/register/index">Register</a>
                                    </div>
                                </div>
                            </div>
                        </div>
